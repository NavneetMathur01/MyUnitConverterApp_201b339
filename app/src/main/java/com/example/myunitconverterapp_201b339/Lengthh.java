...
public class Lengthh extends AppCompatActivity {
    Spinner sp7,sp8;
    EditText e4;
    Button b4;
    TextView t4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lengthh);
        ...
        String[] to = {"CentiMeter","KiloMeter","MilliMeter"};
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(sp7.getSelectedItem().toString() == "Meter" && sp8.getSelectedItem().toString() == "MilliMeter"){
                    ans4 = length*1000;
                    Toast.makeText(getApplicationContext(),ans4.toString(),Toast.LENGTH_LONG).show();
                    t4.setText("" + ans4);
                }
